...
const Referrals = () => {
  ...
  return (
    <PageLayout title="Invite Friends, Earn Rewards" description="Share TaxForge NG and earn free months when friends upgrade" icon={Gift} maxWidth="4xl">
      {/* Stats Cards */}
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Get a free month when they upgrade</p>
            </div>
          </div>
        </CardContent>
      </Card>
