              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={inviteRole} onValueChange={(v) => setInviteRole(v as 'editor' | 'viewer')}>
                    ...
                    <SelectContent>
                      <SelectItem value="viewer">Viewer - Can view businesses and calculations</SelectItem>
                      <SelectItem value="editor">Editor - Can edit and create content</SelectItem>
                      {isCorporate && <SelectItem value="admin">Admin - Full access including settings</SelectItem>}
                    </SelectContent>
                  </Select>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4 min-w-0 flex-1">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {index === 0 && <Badge variant="secondary" className="text-xs">Owner</Badge>}
        ...
        <Card className="border-accent/50 bg-accent/5 mb-6">
          <CardContent className="flex items-center justify-between gap-4 p-4">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <span className="text-sm">Upgrade to Corporate for unlimited team members</span>
            </div>
            <Link to="/pricing">
              ...
              <tbody className="divide-y">
                {[
                  ...
                  <tr key={perm}>
                    ...
                    <td className="text-center">{i < 2 ? <CheckCircle2 className="w-4 h-4 mx-auto text-success" /> : '—'}</td>
                    <td className="text-center">{i < 4 ? <CheckCircle2 className="w-4 h-4 mx-auto text-success" /> : '—'}</td>
