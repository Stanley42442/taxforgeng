            ...
            <table className="w-full min-w-[900px]" style={{ borderCollapse: 'collapse', borderSpacing: 0 }}>
              <thead>
                <tr className="border-b border-border bg-secondary/50">
                  ...
                  <th className="text-center p-4 font-semibold text-foreground min-w-[100px]">Basic</th>
                  <th className="text-center p-4 font-semibold text-foreground min-w-[100px]">Professional</th>
                  <th className="text-center p-4 font-semibold text-primary min-w-[100px]">Business ✦</th>
                  <th className="text-center p-4 font-semibold text-foreground min-w-[100px]">Corporate</th>
                </tr>
              </thead>
            <tbody>
