        ...
        <div className="container mx-auto px-4 py-20 text-center">
          <div className="mx-auto max-w-md">
            ...
            <p className="text-muted-foreground mb-6">
              Available on Freelancer plan and above
            </p>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="text-center mb-8 animate-slide-up">
            ...
            <p className="text-muted-foreground">
              Model different scenarios and see tax impact
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label className="text-sm mb-2 block">
                    Base Turnover: {formatCurrency(baseValues.turnover)}
                  </Label>
                  <Input
                    type="number"
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="0"
                  />
                  <p className="text-xs text-muted-foreground mt-1">Increases rent relief deduction</p>
                </div>

                {/* Foreign Income */}
                <div>
                  <Label className="text-sm mb-2 block">Foreign Income (₦ equivalent)</Label>
                  <Input
                    type="number"
            ...
            <div className="space-y-6 animate-slide-up">
              ...
              <div className={`rounded-2xl p-6 text-center ${
                ...
                <p className="text-sm text-muted-foreground">
                  {taxDifference > 0 
                    ? "You'll pay more in this scenario"
                    : taxDifference < 0 
                    ? "You'll save money in this scenario"
                    : 'No change from current tax'}
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-6 shadow-card">
                ...
                <div className="space-y-3">
                  {adjustments.turnoverChange > 20 && (
                    <div className="p-3 rounded-lg bg-info/10 border border-info/20">
                      <p className="text-sm text-info">
                        📊 A {adjustments.turnoverChange}% turnover increase may require VAT registration if crossing ₦25M threshold
                      </p>
                    </div>
                  )}
                  {adjustments.newRent > 0 && (
                    <div className="p-3 rounded-lg bg-success/10 border border-success/20">
                      <p className="text-sm text-success">
                        🏠 Additional rent of {formatCurrency(adjustments.newRent)} increases your rent relief deduction
                      </p>
                    </div>
                  )}
                  {adjustments.cryptoGains > 0 && (
                    <div className="p-3 rounded-lg bg-warning/10 border border-warning/20">
                      <p className="text-sm text-warning">
                        💰 Crypto gains of {formatCurrency(adjustments.cryptoGains)} attract {formatCurrency(adjustments.cryptoGains * 0.1)} CGT
                      </p>
                    </div>
                  )}
                  {adjustments.foreignIncome > 0 && (
                    <div className="p-3 rounded-lg bg-info/10 border border-info/20">
                      <p className="text-sm text-info">
                        🌍 Foreign income may qualify for treaty benefits - check the Foreign tab
                      </p>
                    </div>
                  )}
                  {Object.values(adjustments).every(v => v === 0) && (
                    <div className="p-3 rounded-lg bg-secondary">
                      <p className="text-sm text-muted-foreground">
                        Adjust the sliders to see how changes affect your tax
                      </p>
                    </div>
                  )}
                </div>
