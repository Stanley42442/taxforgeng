...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How do I remit WHT deducted?', answer: 'WHT must be remitted to the relevant tax authority (NRS for companies, State IRS for individuals) within 21 days of the deduction. A WHT credit note should be issued to the payee.' },
      { question: 'What happens if I don\'t deduct WHT?', answer: 'Failure to deduct or remit WHT carries penalties including the amount of tax not deducted plus 10% per annum interest. NRS can also disallow the expense for CIT purposes if WHT was not properly deducted.' },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How accurate is TaxForge?', answer: 'Our calculations are based on the official Nigeria Tax Act 2025 (effective 2026) and verified against NRS guidelines and Big 4 accounting firm publications. However, TaxForge is an educational tool — always consult a tax professional for official filings.' },
      ...
      { question: 'Does TaxForge file my taxes with NRS?', answer: 'TaxForge does not file taxes directly with NRS (formerly FIRS). It generates accurate calculations and PDF reports that you or your accountant can use when filing through the NRS e-filing portal.' },
