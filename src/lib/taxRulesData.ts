...
export const PIT_BANDS_2026: TaxBand[] = [
  { threshold: 800000, rate: 0, label: 'First NGN 800,000' },
  { threshold: 3000000, rate: 15, label: 'NGN 800,001 - NGN 3,000,000' },
  { threshold: 12000000, rate: 18, label: 'NGN 3,000,001 - NGN 12,000,000' },
  { threshold: 25000000, rate: 21, label: 'NGN 12,000,001 - NGN 25,000,000' },
  { threshold: 50000000, rate: 23, label: 'NGN 25,000,001 - NGN 50,000,000' },
  { threshold: Infinity, rate: 25, label: 'Above NGN 50,000,000' },
];

// PIT Bands - Pre-2026
export const PIT_BANDS_PRE2026: TaxBand[] = [
  { threshold: 300000, rate: 7, label: 'First NGN 300,000' },
  { threshold: 600000, rate: 11, label: 'NGN 300,001 - NGN 600,000' },
  { threshold: 1100000, rate: 15, label: 'NGN 600,001 - NGN 1,100,000' },
  { threshold: 1600000, rate: 19, label: 'NGN 1,100,001 - NGN 1,600,000' },
  { threshold: 3200000, rate: 21, label: 'NGN 1,600,001 - NGN 3,200,000' },
  { threshold: Infinity, rate: 24, label: 'Above NGN 3,200,000' },
];
...
export const KEY_CHANGES: TaxRuleComparison[] = [
  {
    ...
    rule2026: 'First NGN 800,000 exempt (0%)',
    rulePre2026: 'No exemption - 7% from NGN 1',
    change: 'better',
  ...
  },
  {
    ...
    rule2026: '25% (above NGN 50M)',
    rulePre2026: '24% (above NGN 3.2M)',
    change: 'different',
  ...
  },
  {
    ...
    rulePre2026: 'Higher of NGN 200K or 1% + 20% of gross',
    change: 'different',
  ...
  },
  {
    ...
    rule2026: '20% of rent, max NGN 500,000 (requires proof)',
  ...
  },
  {
    ...
    rule2026: '0% CIT if turnover ≤ NGN 50M AND assets ≤ NGN 250M',
  ...
  },
  {
    ...
    rule2026: 'First NGN 50,000,000 exempt',
    rulePre2026: 'First NGN 10,000,000 exempt',
    change: 'better',
  ...
  },
  {
    ...
    rule2026: 'Gains ≤ NGN 10M exempt (if proceeds < NGN 150M)',
...
export const DEDUCTION_RULES = {
  rule2026: [
    { name: 'Rent Relief', calculation: '20% of actual rent', cap: 'NGN 500,000/year', requiresProof: true },
  ...
  rulePre2026: [
    { name: 'CRA', calculation: 'Max(NGN 200K, 1%) + 20%', cap: 'None', requiresProof: false },
    { name: 'Pension', calculation: '8% of gross', cap: 'None', requiresProof: false },
    { name: 'NHF', calculation: '2.5% of basic', cap: 'None', requiresProof: false },
    { name: 'Life Insurance', calculation: 'Actual premiums', cap: 'None', requiresProof: true },
  ],
