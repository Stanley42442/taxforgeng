...
export const translations: Translations = {
  ...
  // Business Report
  'businessReport.title': { en: 'Business Report', pcm: 'Business Report', yo: 'Ìròyìn Iṣẹ́', ha: 'Rahoton Kasuwanci', ig: 'Akụkọ Azụmahịa' },
  'businessReport.subtitle': { en: 'Income, expenses & tax estimates', pcm: 'Income, expenses & tax estimates', yo: 'Owó-wíwọlé, inawo àti àwọn ìṣirò owó-orí', ha: 'Kudin shiga, kashewa da ƙiyasin haraji', ig: 'Ego nnata, mmefu na atụmatụ ụtụ' },
  'businessReport.signIn': { en: 'Please sign in to view reports.', pcm: 'Please sign in to view reports.', yo: 'Jọ̀wọ́ wọlé láti wo àwọn ìròyìn.', ha: 'Da fatan za a shiga don duba rahotanni.', ig: 'Biko banye iji hụ akụkọ.' },
  'businessReport.loading': { en: 'Loading report...', pcm: 'Loading report...', yo: 'Ń ṣe ìròyìn...', ha: 'Ana loda rahoto...', ig: 'Na-ebu akụkọ...' },
  'businessReport.noBusinesses': { en: 'No Businesses', pcm: 'No Business', yo: 'Kò Sí Iṣẹ́', ha: 'Babu Kasuwanci', ig: 'Enweghị Azụmahịa' },
  'businessReport.addBusinessFirst': { en: 'Add a business first to generate expense reports.', pcm: 'Add business first to generate expense reports.', yo: 'Fi iṣẹ́ kan kún ṣáájú láti ṣe àwọn ìròyìn inawo.', ha: 'Ƙara kasuwanci da farko don samar da rahotannin kashewa.', ig: 'Tinye azụmahịa mbụ iji mepụta akụkọ mmefu.' },
  'businessReport.addBusiness': { en: 'Add Business', pcm: 'Add Business', yo: 'Fi Iṣẹ́ Kún', ha: 'Ƙara Kasuwanci', ig: 'Tinye Azụmahịa' },
  'businessReport.selectBusiness': { en: 'Select business', pcm: 'Select business', yo: 'Yan iṣẹ́', ha: 'Zaɓi kasuwanci', ig: 'Họrọ azụmahịa' },
  'businessReport.exportPdf': { en: 'Export PDF', pcm: 'Export PDF', yo: 'Gbé PDF Jáde', ha: 'Fitar da PDF', ig: 'Mbupụ PDF' },
  'businessReport.type': { en: 'Type:', pcm: 'Type:', yo: 'Irú:', ha: 'Nau\'i:', ig: 'Ụdị:' },
  'businessReport.llcCit': { en: 'LLC (CIT)', pcm: 'LLC (CIT)', yo: 'LLC (CIT)', ha: 'LLC (CIT)', ig: 'LLC (CIT)' },
  'businessReport.businessNamePit': { en: 'Business Name (PIT)', pcm: 'Business Name (PIT)', yo: 'Orúkọ Iṣẹ́ (PIT)', ha: 'Sunan Kasuwanci (PIT)', ig: 'Aha Azụmahịa (PIT)' },
  'businessReport.registeredTurnover': { en: 'Registered Turnover:', pcm: 'Registered Turnover:', yo: 'Iye Owó Tí A Forúkọsílẹ̀:', ha: 'Jujjuyar da Aka Rajista:', ig: 'Ntụgharị E Debanyere:' },
  'businessReport.transactions': { en: 'Transactions:', pcm: 'Transactions:', yo: 'Àwọn Ìdúnàádúrà:', ha: "Ma'amaloli:", ig: 'Azụmahịa:' },
  'businessReport.income': { en: 'Income', pcm: 'Income', yo: 'Owó-wíwọlé', ha: 'Kudin Shiga', ig: 'Ego Nnata' },
  'businessReport.expenses': { en: 'Expenses', pcm: 'Expenses', yo: 'Inawo', ha: 'Kashewa', ig: 'Mmefu' },
  'businessReport.deductible': { en: 'Deductible', pcm: 'Deductible', yo: 'Tí A Lè Yọ Kúrò', ha: 'Mai Rage', ig: 'Nke A Ga-Ewepụ' },
  'businessReport.netIncome': { en: 'Net Income', pcm: 'Net Income', yo: 'Owó-wíwọlé Àlékún', ha: 'Tsabar Kudin Shiga', ig: 'Ego Nnata Nọchiri' },
  'businessReport.estTax': { en: 'Est. Tax', pcm: 'Est. Tax', yo: 'Ìṣirò Owó-orí', ha: 'Ƙiyasin Haraji', ig: 'Atụmatụ Ụtụ' },
  'businessReport.expenseBreakdown': { en: 'Expense Breakdown', pcm: 'Expense Breakdown', yo: 'Ìpínpín Inawo', ha: 'Rarraba Kashewa', ig: 'Nkewa Mmefu' },
  'businessReport.noExpenses': { en: 'No expenses recorded yet', pcm: 'No expense record yet', yo: 'Kò sí inawo tí a kọ sílẹ̀ rí', ha: 'Babu kashewar da aka rubuta tukuna', ig: 'Enweghị mmefu edekọrọ' },
  'businessReport.addExpenses': { en: 'Add expenses in the Expenses page to see the breakdown', pcm: 'Add expense for Expenses page to see breakdown', yo: 'Fi inawo kún ní ojú-ìwé Inawo láti rí ìpínpín', ha: 'Ƙara kashewa a shafin Kashewa don ganin rarraba', ig: 'Tinye mmefu na peeji Mmefu iji hụ nkewa' },
  'businessReport.taxSummary': { en: 'Tax Summary', pcm: 'Tax Summary', yo: 'Àkópọ̀ Owó-orí', ha: 'Taƙaitawar Haraji', ig: 'Nchịkọta Ụtụ' },
  'businessReport.taxableIncome': { en: 'Taxable Income', pcm: 'Taxable Income', yo: 'Owó-wíwọlé Tí A Lè Gba Owó-orí Lórí', ha: 'Kudin Shiga da Za a Haraji', ig: 'Ego Nnata A Ga-Atụ Ụtụ' },
  'businessReport.estimatedTax': { en: 'Estimated Tax', pcm: 'Estimated Tax', yo: 'Ìṣirò Owó-orí', ha: 'Ƙiyasin Haraji', ig: 'Atụmatụ Ụtụ' },
  'businessReport.taxDisclaimer': { en: 'This is an estimate based on Nigeria Tax Act 2025. Consult a tax professional for accurate filing.', pcm: 'This na estimate based on Nigeria Tax Act 2025. Consult tax professional for accurate filing.', yo: 'Èyí jẹ́ ìṣirò tí ó dá lórí Òfin Owó-orí Nàíjíríà 2025. Bá ògbóǹtarìgì owó-orí sọ̀rọ̀ fún fífa tó péye.', ha: 'Wannan ƙiyasi ne bisa ga Dokar Haraji ta Najeriya 2025. Tuntubi ƙwararren haraji don shigar da daidai.', ig: 'Nke a bụ atụmatụ dabere na Iwu Ụtụ Naịjirịa 2025. Jụọ ọkachamara ụtụ maka ndekọ ziri ezi.' },
  'businessReport.recentTransactions': { en: 'Recent Transactions', pcm: 'Recent Transactions', yo: 'Àwọn Ìdúnàádúrà Àìpẹ́', ha: "Ma'amalolin Kwanan Nan", ig: 'Azụmahịa Na-adịbeghị Anya' },
  'businessReport.noTransactions': { en: 'No transactions recorded', pcm: 'No transaction recorded', yo: 'Kò sí ìdúnàádúrà tí a kọ sílẹ̀', ha: "Babu ma'amalar da aka rubuta", ig: 'Enweghị azụmahịa edekọrọ' },
  'businessReport.addTransactionsHint': { en: 'Add income and expenses in the Expenses page', pcm: 'Add income and expense for Expenses page', yo: 'Fi owó-wíwọlé àti inawo kún ní ojú-ìwé Inawo', ha: 'Ƙara kudin shiga da kashewa a shafin Kashewa', ig: 'Tinye ego nnata na mmefu na peeji Mmefu' },
  'businessReport.goToExpenses': { en: 'Go to Expenses', pcm: 'Go to Expenses', yo: 'Lọ Sí Inawo', ha: 'Je zuwa Kashewa', ig: 'Gaa na Mmefu' },

  // Terms Page
  'terms.title': { en: 'Terms of Service & Privacy Policy', pcm: 'Terms of Service & Privacy Policy', yo: 'Àwọn Òfin Ìṣẹ́ àti Ìlànà Ìkọ̀kọ̀', ha: 'Sharuɗɗan Sabis da Manufar Sirri', ig: 'Usoro Ọrụ na Amụma Nzuzo' },
  'terms.lastUpdated': { en: 'Last updated:', pcm: 'Last updated:', yo: 'Ìgbà tí a ṣe àtúnṣe ìkẹyìn:', ha: 'An sabunta karshe:', ig: 'Emezigharịrị ikpeazụ:' },
  'terms.disclaimer': { en: 'Important Disclaimer', pcm: 'Important Disclaimer', yo: 'Ìkìlọ̀ Pàtàkì', ha: 'Muhimmin Faɗakarwa', ig: 'Ịdọ Aka Ná Ntị Dị Mkpa' },
  'terms.disclaimerText': { en: 'TaxForge NG provides educational tax estimates based on the Nigeria Tax Act 2025. This is NOT official tax advice. Always consult FIRS, state IRS, or certified tax professionals for official guidance. We are not liable for any errors, omissions, or decisions made based on information from this platform.', pcm: 'TaxForge NG dey provide educational tax estimate based on Nigeria Tax Act 2025. This no be official tax advice. Always consult FIRS, state IRS, or certified tax professional for official guidance. We no go hold responsible for any error, omission, or decision wey you take based on information from this platform.', yo: 'TaxForge NG pèsè àwọn ìṣirò owó-orí fún ẹ̀kọ́ tí ó dá lórí Òfin Owó-orí Nàíjíríà 2025. Èyí KÌÍ ṣe ìmọ̀ràn owó-orí ìjọba. Máa bá FIRS, IRS ìpínlẹ̀, tàbí àwọn ògbóǹtarìgì owó-orí tí a fọwọ́sí sọ̀rọ̀ fún ìtọ́sọ́nà ìjọba. A kò ní jẹbí fún àṣìṣe, àìsí, tàbí àwọn ìpinnu tí a ṣe dá lórí àlàyé láti ọ̀dọ̀ pèpélè yìí.', ha: 'TaxForge NG tana ba da ƙiyasin haraji na ilimi bisa ga Dokar Haraji ta Najeriya 2025. Wannan BA shawarar haraji ta hukuma ba ce. Ku yi shawarwari da FIRS, IRS na jiha, ko ƙwararrun haraji masu lasisi don jagorancin hukuma. Ba mu da alhakin kowane kuskure, abin da aka manta, ko yanke shawara da aka yi bisa bayanan daga wannan dandali.', ig: 'TaxForge NG na-enye atụmatụ ụtụ maka mmụta dabere na Iwu Ụtụ Naịjirịa 2025. Nke a ABỤGHỊ ndụmọdụ ụtụ gọọmentị. Na-ajụtanụ FIRS, IRS steeti, maọbụ ndị ọkachamara ụtụ nwere akwụkwọ ikike maka nduzi gọọmentị. Anyị anaghị ata ụta maka njehie ọ bụla, ihe a hapụrụ, maọbụ mkpebi e mere dabere na ozi sitere na ikpo okwu a.' },
  'terms.termsOfService': { en: 'Terms of Service', pcm: 'Terms of Service', yo: 'Àwọn Òfin Ìṣẹ́', ha: 'Sharuɗɗan Sabis', ig: 'Usoro Ọrụ' },
  'terms.privacyPolicy': { en: 'Privacy Policy', pcm: 'Privacy Policy', yo: 'Ìlànà Ìkọ̀kọ̀', ha: 'Manufar Sirri', ig: 'Amụma Nzuzo' },
  'terms.contactUs': { en: 'Contact Us', pcm: 'Contact Us', yo: 'Kàn Sí Wa', ha: 'Tuntuɓe Mu', ig: 'Kpọtụrụ Anyị' },
  'terms.contactText': { en: 'For questions about these terms, privacy concerns, or data requests, contact us at:', pcm: 'For questions about these terms, privacy concern, or data request, contact us for:', yo: 'Fún àwọn ìbéèrè nípa àwọn òfin wọ̀nyí, àníyàn ìkọ̀kọ̀, tàbí ìbéèrè dátà, kàn sí wa ní:', ha: 'Don tambayoyi game da waɗannan sharuɗɗa, damuwa game da sirri, ko buƙatun bayanai, tuntube mu a:', ig: 'Maka ajụjụ gbasara usoro ndị a, nchegbu nzuzo, maọbụ arịrịọ data, kpọtụrụ anyị na:' },
  'terms.footer': { en: 'By using TaxForge NG, you acknowledge that you have read, understood, and agree to these Terms of Service and Privacy Policy.', pcm: 'By using TaxForge NG, you agree say you don read, understand, and agree to these Terms of Service and Privacy Policy.', yo: 'Nípa lílo TaxForge NG, o jẹ́wọ́ pé o ti ka, lóye, àti gbà àwọn Òfin Ìṣẹ́ àti Ìlànà Ìkọ̀kọ̀ wọ̀nyí.', ha: 'Ta hanyar amfani da TaxForge NG, kun yarda cewa kun karanta, kun fahimta, kuma kun yarda da waɗannan Sharuɗɗan Sabis da Manufar Sirri.', ig: 'Site na iji TaxForge NG, ị na-ekwupụta na ịgụọla, ghọtara, ma kwenye na Usoro Ọrụ ndị a na Amụma Nzuzo.' },
};
