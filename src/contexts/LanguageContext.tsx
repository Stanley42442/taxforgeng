...
export const translations: Translations = {
  ...
  'security.ipWhitelist.yourIp': { en: 'Your IP', pcm: 'Your IP', yo: 'IP Rẹ', ha: 'IP ɗinku', ig: 'IP Gị' },
  'security.ipWhitelist.whitelisted': { en: 'Whitelisted', pcm: 'Whitelisted', yo: 'Ti Wà Nínú Àtòjọ', ha: 'A Cikin Jeri', ig: 'Nọ na Ndepụta' },
  'security.ipWhitelist.notWhitelisted': { en: 'Not whitelisted', pcm: 'Not whitelisted', yo: 'Kò Sí Nínú Àtòjọ', ha: 'Ba a cikin jeri ba', ig: 'Ọ nọghị na Ndepụta' },
  'security.ipWhitelist.addThisIp': { en: 'Add This IP', pcm: 'Add This IP', yo: 'Fi IP Yìí Kún', ha: 'Ƙara Wannan IP', ig: 'Tinye IP A' },
  ...
  'security.ipWhitelist.lockoutWarning': { en: "You won't be able to log in from any IP address. Add at least one IP to avoid being locked out.", pcm: "You no go fit login from any IP address. Add at least one IP so you no go lock yourself out.", yo: "O kò ní lè wọlé láti àdírẹ́sì IP kankan. Fi ó kéré jù IP kan kún láti yàgò fún títì ara rẹ sílẹ̀.", ha: "Ba za ku iya shiga daga kowane adireshin IP ba. Ƙara aƙalla IP ɗaya don guje wa kulle.", ig: "Ị gaghị enwe ike ịbanye site na adreesị IP ọ bụla. Tinye opekata mpe IP otu iji zere mkpọchi." },
  'security.ipWhitelist.addIpAddress': { en: 'Add IP Address', pcm: 'Add IP Address', yo: 'Fi Àdírẹ́sì IP Kún', ha: 'Ƙara Adireshin IP', ig: 'Tinye Adreesị IP' },
  'security.ipWhitelist.export': { en: 'Export', pcm: 'Export', yo: 'Gbé Jáde', ha: 'Fitar', ig: 'Mbupụ' },
  'security.ipWhitelist.import': { en: 'Import', pcm: 'Import', yo: 'Gbé Wọlé', ha: 'Shigo', ig: 'Mbubata' },
  'security.ipWhitelist.noEntries': { en: 'No IP addresses whitelisted', pcm: 'No IP address whitelisted', yo: 'Kò sí àdírẹ́sì IP nínú àtòjọ', ha: 'Babu adireshin IP a cikin jeri', ig: 'Enweghị adreesị IP na ndepụta' },
