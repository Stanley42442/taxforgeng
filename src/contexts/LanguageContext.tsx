...
export const getToastMessage = (key: string, language: Language): string => {
  ...
  return key;
  // Security Analytics
  'security.analytics.totalLogins': { en: 'Total Logins', pcm: 'Total Logins', yo: 'Àpapọ̀ Ìwọlé', ha: 'Jimlar Shigarwa', ig: 'Mkpokọta Ịbanye' },
  'security.analytics.failedAttempts': { en: 'Failed Attempts', pcm: 'Failed Attempts', yo: 'Àwọn Ìgbìyànjú Tí Kùnà', ha: 'Yunƙurin da Ba Su Yi Nasara Ba', ig: 'Ọnwụnwa Dara Ada' },
  'security.analytics.successRate': { en: 'Success Rate', pcm: 'Success Rate', yo: 'Ìwọ̀n Àṣeyọrí', ha: 'Adadin Nasara', ig: 'Ọnụ Ọgụgụ Ihe Ịga Nke Ọma' },
  'security.analytics.uniqueIPs': { en: 'Unique IPs', pcm: 'Unique IPs', yo: 'Àwọn IP Àkànṣe', ha: 'IPs Musamman', ig: 'IP Pụrụ Iche' },
  'security.analytics.loginActivity': { en: 'Login Activity (Last 14 Days)', pcm: 'Login Activity (Last 14 Days)', yo: 'Ìṣe Ìwọlé (Ọjọ́ 14 Sẹ́yìn)', ha: 'Ayyukan Shiga (Kwanaki 14 da Suka Gabata)', ig: 'Ihe Omume Ịbanye (Ụbọchị 14 Gara Aga)' },
  'security.analytics.loginActivityDesc': { en: 'Successful and failed login attempts over time', pcm: 'Successful and failed login attempts over time', yo: 'Àwọn ìgbìyànjú ìwọlé tó ṣàṣeyọrí àti tí kùnà lórí àkókò', ha: 'Yunƙurin shiga da suka yi nasara da waɗanda suka gaza cikin lokaci', ig: 'Ọnwụnwa ịbanye gara nke ọma na nke dara ada n\'oge' },
  'security.analytics.successful': { en: 'Successful', pcm: 'Successful', yo: 'Àṣeyọrí', ha: 'Nasara', ig: 'Ihe Ịga Nke Ọma' },
  'security.analytics.failed': { en: 'Failed', pcm: 'Failed', yo: 'Kùnà', ha: 'Ba A Yi Nasara Ba', ig: 'Dara Ada' },
  'security.analytics.eventTypes.title': { en: 'Event Types', pcm: 'Event Types', yo: 'Àwọn Irú Ìṣẹ̀lẹ̀', ha: 'Nau\'ikan Abubuwan da Suka Faru', ig: 'Ụdị Ihe Omume' },
  'security.analytics.eventTypesDesc': { en: 'Distribution of security events', pcm: 'Distribution of security events', yo: 'Ìpínpín àwọn ìṣẹ̀lẹ̀ ààbò', ha: 'Rarraba abubuwan tsaro', ig: 'Nkesa ihe omume nchekwa' },
  'security.analytics.eventTypes.login': { en: 'Login', pcm: 'Login', yo: 'Ìwọlé', ha: 'Shigarwa', ig: 'Ịbanye' },
  'security.analytics.eventTypes.loginSuccess': { en: 'Login Success', pcm: 'Login Success', yo: 'Ìwọlé Àṣeyọrí', ha: 'Nasarar Shiga', ig: 'Ịbanye Gara Nke Ọma' },
  'security.analytics.eventTypes.loginFailed': { en: 'Failed Login', pcm: 'Failed Login', yo: 'Ìwọlé Kùnà', ha: 'Shigar da Ba Ta Yi Nasara Ba', ig: 'Ịbanye Dara Ada' },
  'security.analytics.eventTypes.logout': { en: 'Logout', pcm: 'Logout', yo: 'Ìjáde', ha: 'Fita', ig: 'Ịpụ' },
  'security.analytics.eventTypes.passwordChange': { en: 'Password Change', pcm: 'Password Change', yo: 'Ìyípadà Ọ̀rọ̀-aṣínà', ha: 'Canjin Kalmar Sirri', ig: 'Mgbanwe Okwuntughe' },
  'security.analytics.eventTypes.2faEnabled': { en: '2FA Enabled', pcm: '2FA Enabled', yo: '2FA Tí A Ti Mú Ṣiṣẹ́', ha: '2FA An Kunna', ig: '2FA Emere Ka Ọ Rụọ' },
  'security.analytics.eventTypes.2faDisabled': { en: '2FA Disabled', pcm: '2FA Disabled', yo: '2FA Tí A Ti Dá Dúró', ha: '2FA An Kashe', ig: '2FA Emechiri' },
  'security.analytics.eventTypes.signup': { en: 'Signup', pcm: 'Signup', yo: 'Ìforúkọsílẹ̀', ha: 'Rajista', ig: 'Debanye Aha' },
  'security.analytics.eventTypes.backupCodes': { en: 'Backup Codes', pcm: 'Backup Codes', yo: 'Àwọn Kóòdù Ìpamọ́', ha: 'Lambobin Ajiya', ig: 'Koodu Ndabere' },
  'security.analytics.eventTypes.profileUpdate': { en: 'Profile Update', pcm: 'Profile Update', yo: 'Ìmúdójúìwọ̀n Àkọsílẹ̀', ha: 'Sabunta Bayani', ig: 'Mmelite Profaịlụ' },
  'security.analytics.loginTimes': { en: 'Login Times', pcm: 'Login Times', yo: 'Àwọn Àkókò Ìwọlé', ha: 'Lokutan Shiga', ig: 'Oge Ịbanye' },
  'security.analytics.loginTimesDesc': { en: 'When you typically log in', pcm: 'When you dey usually log in', yo: 'Ìgbà tí o sábà máa ń wọlé', ha: 'Lokacin da kuke yawan shiga', ig: 'Mgbe ị na-ebanye n\'oge' },
  'security.analytics.loginLocations': { en: 'Login Locations', pcm: 'Login Locations', yo: 'Àwọn Ibùdó Ìwọlé', ha: 'Wuraren Shiga', ig: 'Ebe Ịbanye' },
  'security.analytics.loginLocationsDesc': { en: 'Countries you\'ve logged in from', pcm: 'Countries wey you don log in from', yo: 'Àwọn orílẹ̀-èdè tí o ti wọlé láti', ha: 'Ƙasashen da kuka shiga daga', ig: 'Mba ndị ị banyere site na' },
  'security.analytics.logins': { en: 'logins', pcm: 'logins', yo: 'àwọn ìwọlé', ha: 'shigarwa', ig: 'ịbanye' },
  'security.notifications.title': { en: 'Notification Delivery Log', pcm: 'Notification Delivery Log', yo: 'Àkọsílẹ̀ Ìfijíṣẹ̀ Ìwífúnni', ha: 'Rajistan Isarwar Sanarwa', ig: 'Ndekọ Nnyefe Ọkwa' },
  'security.notifications.description': { en: 'Track which notifications were sent via WhatsApp, SMS, or Email', pcm: 'Track which notifications wey dem send via WhatsApp, SMS, or Email', yo: 'Tọpinpin àwọn ìwífúnni tí a ránṣẹ́ nípasẹ̀ WhatsApp, SMS, tàbí Ímeèlì', ha: 'Bincika sanarwar da aka aika ta WhatsApp, SMS, ko Imel', ig: 'Soro nke ọkwa ezigara site na WhatsApp, SMS, ma ọ bụ Email' },
  'security.notifications.new': { en: 'New', pcm: 'New', yo: 'Tuntun', ha: 'Sabo', ig: 'Ọhụrụ' },
  'security.notifications.notificationDelivered': { en: 'notification delivered', pcm: 'notification delivered', yo: 'ìwífúnni ti dé', ha: 'an isar da sanarwa', ig: 'enyefere ọkwa' },
  'security.notifications.email': { en: 'Email', pcm: 'Email', yo: 'Ímeèlì', ha: 'Imel', ig: 'Email' },
  'security.notifications.failed': { en: 'Failed', pcm: 'Failed', yo: 'Kùnà', ha: 'Ba A Yi Nasara Ba', ig: 'Dara Ada' },
  'security.notifications.sent': { en: 'Sent', pcm: 'Sent', yo: 'Ti Ránṣẹ́', ha: 'An Aika', ig: 'Ezigara' },
  'security.notifications.delivered': { en: 'Delivered', pcm: 'Delivered', yo: 'Ti Dé', ha: 'An Isar', ig: 'Enyefere' },
  'security.notifications.pending': { en: 'Pending', pcm: 'Pending', yo: 'Ń Dúró', ha: 'Ana Jira', ig: 'Na-eche' },
  'security.notifications.method': { en: 'Method', pcm: 'Method', yo: 'Ọ̀nà', ha: 'Hanya', ig: 'Ụzọ' },
  'security.notifications.allMethods': { en: 'All Methods', pcm: 'All Methods', yo: 'Gbogbo Ọ̀nà', ha: 'Duk Hanyoyi', ig: 'Ụzọ Niile' },
  'security.notifications.status': { en: 'Status', pcm: 'Status', yo: 'Ipò', ha: 'Matsayi', ig: 'Ọnọdụ' },
  'security.notifications.allStatus': { en: 'All Status', pcm: 'All Status', yo: 'Gbogbo Ipò', ha: 'Duk Matsayi', ig: 'Ọnọdụ Niile' },
  'security.notifications.alertType': { en: 'Alert Type', pcm: 'Alert Type', yo: 'Irú Ìkìlọ̀', ha: 'Nau\'in Faɗakarwa', ig: 'Ụdị Ịdọ Aka Ná Ntị' },
  'security.notifications.allAlerts': { en: 'All Alerts', pcm: 'All Alerts', yo: 'Gbogbo Ìkìlọ̀', ha: 'Duk Faɗakarwa', ig: 'Ịdọ Aka Ná Ntị Niile' },
  'security.notifications.to': { en: 'To', pcm: 'To', yo: 'Sí', ha: 'Zuwa', ig: 'Na' },
  'security.notifications.noDeliveries': { en: 'No notification deliveries found', pcm: 'No notification delivery dey', yo: 'Kò sí ìfijíṣẹ̀ ìwífúnni', ha: 'Ba a sami isarwar sanarwa ba', ig: 'Ahụghị nnyefe ọkwa ọ bụla' },
  'security.notifications.noDeliveriesHint': { en: 'Deliveries will appear here when security alerts are sent', pcm: 'Deliveries go show here when security alert dey send', yo: 'Àwọn ìfijíṣẹ̀ yóò hàn níbí nígbà tí a bá ránṣẹ́ àwọn ìkìlọ̀ ààbò', ha: 'Isarwa za ta bayyana a nan lokacin da aka aika da faɗakarwar tsaro', ig: 'Nnyefe ga-apụta ebe a mgbe a na-eziga ịdọ aka ná ntị nchekwa' },
  'security.notifications.alertTypes.failedBackupCodes': { en: 'Failed Backup Codes', pcm: 'Failed Backup Codes', yo: 'Àwọn Kóòdù Ìpamọ́ Tí Kùnà', ha: 'Lambobin Ajiya da Suka Gaza', ig: 'Koodu Ndabere Dara Ada' },
  'security.notifications.alertTypes.accountLocked': { en: 'Account Locked', pcm: 'Account Locked', yo: 'Àkọọ́lẹ̀ Tí A Ti Tìí', ha: 'An Kulle Asusu', ig: 'Akaụntụ Akpọchiri' },
  'security.notifications.alertTypes.newDevice': { en: 'New Device', pcm: 'New Device', yo: 'Ẹ̀rọ Tuntun', ha: 'Sabuwar Na\'ura', ig: 'Ngwaọrụ Ọhụrụ' },
  'security.notifications.alertTypes.deviceRemoved': { en: 'Device Removed', pcm: 'Device Removed', yo: 'A Ti Yọ Ẹ̀rọ Kúrò', ha: 'An Cire Na\'ura', ig: 'Ewepụrụ Ngwaọrụ' },
  'security.notifications.alertTypes.sessionsRevoked': { en: 'Sessions Revoked', pcm: 'Sessions Revoked', yo: 'A Ti Fagile Àwọn Ìgbà', ha: 'An Soke Zama', ig: 'Agbanyụọla Oge' },
  'security.notifications.alertTypes.newLocation': { en: 'New Location', pcm: 'New Location', yo: 'Ibùdó Tuntun', ha: 'Sabon Wuri', ig: 'Ebe Ọhụrụ' },
  'security.notifications.alertTypes.deviceBlocked': { en: 'Device Blocked', pcm: 'Device Blocked', yo: 'A Ti Dínà Ẹ̀rọ', ha: 'An Toshe Na\'ura', ig: 'Egbochiri Ngwaọrụ' },
  'security.notifications.alertTypes.passwordChanged': { en: 'Password Changed', pcm: 'Password Changed', yo: 'A Ti Yi Ọ̀rọ̀-aṣínà Padà', ha: 'An Canja Kalmar Sirri', ig: 'Agbanweela Okwuntughe' },
  'security.notifications.alertTypes.2faEnabled': { en: '2FA Enabled', pcm: '2FA Enabled', yo: '2FA Tí A Ti Mú Ṣiṣẹ́', ha: '2FA An Kunna', ig: '2FA Emere Ka Ọ Rụọ' },
  'security.notifications.alertTypes.2faDisabled': { en: '2FA Disabled', pcm: '2FA Disabled', yo: '2FA Tí A Ti Dá Dúró', ha: '2FA An Kashe', ig: '2FA Emechiri' },
  'security.notifications.alertTypes.backupCodesGenerated': { en: 'Backup Codes Generated', pcm: 'Backup Codes Generated', yo: 'A Ti Ṣẹ̀dá Àwọn Kóòdù Ìpamọ́', ha: 'An Ƙirƙiri Lambobin Ajiya', ig: 'Emepụtara Koodu Ndabere' },
  'security.notifications.alertTypes.emailChanged': { en: 'Email Changed', pcm: 'Email Changed', yo: 'A Ti Yi Ímeèlì Padà', ha: 'An Canja Imel', ig: 'Agbanweela Email' },
  'security.notifications.alertTypes.unusualTime': { en: 'Unusual Time', pcm: 'Unusual Time', yo: 'Àkókò Àjèjì', ha: 'Lokaci Mara Al\'ada', ig: 'Oge Adịghị Ahụkebe' },
  'security.notifications.alertTypes.ipBlocked': { en: 'IP Blocked', pcm: 'IP Blocked', yo: 'A Ti Dínà IP', ha: 'An Toshe IP', ig: 'Egbochiri IP' },
  'security.notifications.alertTypes.timeRestricted': { en: 'Time Restricted', pcm: 'Time Restricted', yo: 'Àkókò Dín', ha: 'An Ƙuntata Lokaci', ig: 'Oge Akwụsịrị' },
  'advisory.skipToCalculator': { en: 'Skip to Calculator', pcm: 'Skip to Calculator', yo: 'Lọ sí Ẹ̀rọ ìṣirò', ha: 'Tsallake zuwa Lissafi', ig: 'Wụsa gaa Ngwa Mgbako' },
  'advisory.question': { en: 'Question', pcm: 'Question', yo: 'Ìbéèrè', ha: 'Tambaya', ig: 'Ajụjụ' },
  'advisory.complete': { en: 'Complete', pcm: 'Complete', yo: 'Parí', ha: 'Cikakke', ig: 'Zuru Ezu' },
  ...
  'common.live': { en: 'Live', pcm: 'Live', yo: 'Ní Ìṣẹ̀lẹ̀', ha: 'Rayuwa', ig: 'N\'oge' },
  'common.new': { en: 'new', pcm: 'new', yo: 'tuntun', ha: 'sabo', ig: 'ọhụrụ' },
  'common.refresh': { en: 'Refresh', pcm: 'Refresh', yo: 'Ṣe Àtúnṣe', ha: 'Sabunta', ig: 'Megharia' },
  'common.total': { en: 'Total', pcm: 'Total', yo: 'Àpapọ̀', ha: 'Jimla', ig: 'Mkpokọta' },
  'common.error': { en: 'Error', pcm: 'Error', yo: 'Àṣìṣe', ha: 'Kuskure', ig: 'Njehie' },
  'common.unknown': { en: 'Unknown', pcm: 'Unknown', yo: 'Àìmọ̀', ha: 'Ba A Sani Ba', ig: 'Amaghị' },
  'common.of': { en: 'of', pcm: 'of', yo: 'nínú', ha: 'na', ig: 'n\'ime' },
  'common.back': { en: 'Back', pcm: 'Back', yo: 'Padà', ha: 'Baya', ig: 'Azụ' },
};
