...
export const translations: Translations = {
  ...
  'security.score.excellent': { en: 'Excellent', pcm: 'Excellent', yo: 'Dára Púpọ̀', ha: 'Kyakkyawa', ig: 'Ọ dị mma nke ukwuu' },
  'security.score.veryGood': { en: 'Very Good', pcm: 'Very Good', yo: 'Dára Gan', ha: 'Da Kyau Sosai', ig: 'Ọ dị mma nke ukwuu' },
  'security.score.good': { en: 'Good', pcm: 'Good', yo: 'Dára', ha: 'Da Kyau', ig: 'Ọ dị mma' },
  'security.score.fair': { en: 'Fair', pcm: 'Fair', yo: 'Ó Yẹ', ha: 'Adalci', ig: 'Ọ dị mma n\'ókè' },
  'security.score.needsImprovement': { en: 'Needs Improvement', pcm: 'Needs Improvement', yo: 'Ó Nílò Àtúnṣe', ha: 'Yana Buƙatar Ingantawa', ig: 'Ọ chọrọ Imeziwanye' },
  ...
  // Phase 3: Advisory Page & Logic
  'advisory.title': { en: 'Our Recommendation', pcm: 'Our Recommendation', yo: 'Ìmọ̀ràn Wa', ha: 'Shawarar Mu', ig: 'Ndụmọdụ Anyị' },
  'advisory.match': { en: 'Match', pcm: 'Match', yo: 'Ìbámu', ha: 'Dacewa', ig: 'Ndakọrịta' },
  'advisory.advantages': { en: 'Advantages', pcm: 'Advantages', yo: 'Àwọn Àǹfààní', ha: 'Amfanoni', ig: 'Uru' },
  'advisory.considerations': { en: 'Considerations', pcm: 'Considerations', yo: 'Àwọn Ìṣàkóso', ha: 'Abubuwan La\'akari', ig: 'Ihe A Ga-Atụle' },
  'advisory.taxAuthority': { en: 'Tax Authority', pcm: 'Tax Authority', yo: 'Aṣẹ Owó-orí', ha: 'Hukumar Haraji', ig: 'Ọchịchị Ụtụ' },
  'advisory.registrationCost': { en: 'Registration Cost', pcm: 'Registration Cost', yo: 'Iye Ìforúkọsílẹ̀', ha: 'Farashin Rajista', ig: 'Ọnụ Ahịa Ndebanye Aha' },
  'advisory.annualCompliance': { en: 'Annual Compliance', pcm: 'Annual Compliance', yo: 'Ìbọ̀wọ̀ Ọdọọdún', ha: 'Biyayya ta Shekara-shekara', ig: 'Nkwekọrịta Kwa Afọ' },
  'advisory.calculateTaxes': { en: 'Calculate Your Taxes', pcm: 'Calculate Your Taxes', yo: 'Ṣe Ìṣirò Owó-orí Rẹ', ha: 'Ƙididdige Haraji', ig: 'Gbakọọ Ụtụ Gị' },
  'advisory.startOver': { en: 'Start Over', pcm: 'Start Over', yo: 'Bẹ̀rẹ̀ Lẹ́ẹ̀kan Síi', ha: 'Sake Farawa', ig: 'Malite Ọzọ' },
  'advisory.skipToCalculator': { en: 'Skip to Calculator', pcm: 'Skip to Calculator', yo: 'Fò Lọ Sí Èrọ Ìṣirò', ha: 'Tsallake zuwa Lissafi', ig: 'Mafere Gaa na Ngwa Mgbako' },
  'advisory.question': { en: 'Question', pcm: 'Question', yo: 'Ìbéèrè', ha: 'Tambaya', ig: 'Ajụjụ' },
  'advisory.of': { en: 'of', pcm: 'of', yo: 'nínú', ha: 'na', ig: 'n\'ime' },
  'advisory.complete': { en: 'Complete', pcm: 'Complete', yo: 'Parí', ha: 'Cika', ig: 'Zuo Oke' },
  ...
  'advisory.assetProtectionQ': { en: 'Do you need protection for personal assets?', pcm: 'You need protection for your personal property?', yo: 'Ṣé o nílò àbò fún àwọn ohun-ìní ara ẹni rẹ?', ha: 'Kuna buƙatar kariya ga dukiya?' },
