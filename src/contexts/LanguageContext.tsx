...
export const translations: Translations = {
  ...
  // Form Labels
  'form.email': { en: 'Email', pcm: 'Email', yo: 'Ímeèlì', ha: 'Imel', ig: 'Email' },
  'form.password': { en: 'Password', pcm: 'Password', yo: 'Ọ̀rọ̀ Aṣínà', ha: 'Kalmar Sirri', ig: 'Okwuntụghe' },
  'form.confirmPassword': { en: 'Confirm Password', pcm: 'Confirm Password', yo: 'Jẹ́rìísí Ọ̀rọ̀ Aṣínà', ha: 'Tabbatar da Kalmar Sirri', ig: 'Kwado Okwuntụghe' },
  'form.fullName': { en: 'Full Name', pcm: 'Your Full Name', yo: 'Orúkọ Kíkún', ha: 'Cikakken Suna', ig: 'Aha Zuru Oke' },
  'form.phoneNumber': { en: 'Phone Number', pcm: 'Phone Number', yo: 'Nọ́ńbà Fóònù', ha: 'Lambar Waya', ig: 'Nọmba Ekwentị' },
  'form.businessName': { en: 'Business Name', pcm: 'Business Name', yo: 'Orúkọ Iṣẹ́', ha: 'Sunan Kasuwanci', ig: 'Aha Azụmahịa' },
  'form.amount': { en: 'Amount', pcm: 'Amount', yo: 'Iye', ha: 'Adadi', ig: 'Ego' },
  'form.description': { en: 'Description', pcm: 'Description', yo: 'Àlàyé', ha: 'Bayani', ig: 'Nkọwa' },
  'form.category': { en: 'Category', pcm: 'Category', yo: 'Ẹ̀ka', ha: 'Nau\'i', ig: 'Ụdị' },
  'form.date': { en: 'Date', pcm: 'Date', yo: 'Ọjọ́', ha: 'Kwanan Wata', ig: 'Ụbọchị' },
